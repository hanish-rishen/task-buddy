        ...
        <form onSubmit={handleSubmit}>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="skills" value={skills} onChange={(e) => setSkills(e.target.value)} placeholder="Gardening, Cooking, Tutoring" />
            </div>
          ...
          <CardFooter className="flex flex-col space-y-4">
            ...
            <Button type="button" onClick={handleGoogleSignUp} className="w-full bg-white text-gray-700 border border-gray-300 hover:bg-gray-100 flex items-center justify-center">
